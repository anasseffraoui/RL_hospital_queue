...
from app.simulation.policies.Random import Random  # Add this import
from app.simulation.envs.RandomEnv import RandomEnv  # Add this import
...
def main():
    ...
    #model = Random("Random_Baseline")

    model.learn(scenario, 1000, 1)
    ...
    model.simulate(env, print_logs=False, save_to_csv=True, path="app/data/results/", file_name="result_0.csv")
