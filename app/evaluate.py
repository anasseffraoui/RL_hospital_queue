...
from app.simulation.policies.ChildPolicy import ChildPolicy  # Changed
from app.simulation.envs.RandomEnv import RandomEnv  # Changed
from app.simulation.policies.Random import Random  # Changed
import pandas as pd
...
model = ChildPolicy("Env")  # Changed
model.load_model("./models/Env/final_model")  # Load trained model

# Register environment
register(
    id="Child_Env",  # Fixed capitalization
    entry_point="app.simulation.envs.ChildEnv:ChildEnv", 
)
env_id = "Child_Env"  # Fixed capitalization

# ... rest of the file stays the same


'''# Use Random policy
model = Random("Random_Baseline")  # Changed this line

# Register RandomEnv
register(
    id="Random_Env",  # Changed
    entry_point="app.simulation.envs.RandomEnv:RandomEnv",  # Changed
)
env_id = "Random_Env"  # Changed'''
